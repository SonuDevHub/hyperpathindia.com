                ...
                <div class="page-header-inner tt-wrap">
                    <div class="ph-caption">
                        <div class="ph-caption-inner">
                            <h2 class="ph-caption-subtitle">Your Privacy
                                Matters</h2>
                            <h1 class="ph-caption-title">Privacy</h1>
                            <div
                                class="ph-caption-description max-width-700">
                                Understand how we use your data.<br> Read
                                our privacy policy in full here.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ph-mask-inner tt-wrap">
                        <div class="ph-caption">
                            <div class="ph-caption-inner">
                                <h2 class="ph-caption-subtitle">Your Privacy
                                    Matters</h2>
                                <h1 class="ph-caption-title">Privacy
                                    Policy</h1>
                                <div
                                    class="ph-caption-description max-width-700">
                                    Learn what we collect and why.<br>
                                    Manage privacy choices and rights
                                    anytime easily.
                                </div>
                            </div>
                        </div>
