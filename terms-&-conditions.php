                ...
                <div class="page-header-inner tt-wrap">
                    <div class="ph-caption">
                        <div class="ph-caption-inner">
                            <h2 class="ph-caption-subtitle">Review Our
                                Terms</h2>
                            <h1 class="ph-caption-title">Our Terms</h1>
                            <div
                                class="ph-caption-description max-width-700">
                                Understand the rules for using our
                                website.<br> Read our terms before
                                continuing.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ph-mask-inner tt-wrap">
                        <div class="ph-caption">
                            <div class="ph-caption-inner">
                                ...
                                <div
                                    class="ph-caption-description max-width-700">
                                    Learn how we operate and what we
                                    expect.<br> Read these terms to stay
                                    informed.
                                </div>
                            </div>
                        </div>
